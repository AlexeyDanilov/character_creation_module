...
def attack(char_name: str, char_class: str) -> str:
    """Функция для высиления последствий атаки атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция для определения уровня защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция для вычисления особенностей."""
    if char_class == 'warrior':
        endurance = 80 + 25
    ...
    if char_class == 'mage':
        endurance = 5 + 40
        return (f'{char_name} применил специальное умение «Атака {endurance}»')
    if char_class == 'healer':
        endurance = 10 + 30
        return (f'{char_name} применил специальное '
                'умение «Защита {endurance}»')
    return ''
